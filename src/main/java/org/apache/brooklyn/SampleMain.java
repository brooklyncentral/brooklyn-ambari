...
import org.apache.brooklyn.ambari.AmbariApp;
import org.apache.brooklyn.sample.app.*;
...
public class SampleMain extends Main {
    ...
    public static class LaunchCommand extends Main.LaunchCommand {
        ...
        @Option(name = { "--ambari" }, description = "Launch ambari")
        ...
        public Void call() throws Exception {
            ...
            if (ambari) setAppToLaunch( AmbariApp.class.getCanonicalName() );
